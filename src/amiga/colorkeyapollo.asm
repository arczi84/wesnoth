...
_LVOCacheClearU     EQU   -636		;yes, yes I know...
	...
	XDEF	___wrap_ApolloKeyRGB565toRGB565	;
...
;D6 = key color
___wrap_ApolloKeyRGB565toRGB565:
	movem.l	d4-d5/d7,-(sp)

	cmp.l	#4,d0
	blt		m68kKeyRGB565toRGB565 ; don't bother if < 4 pixels wide..

	vperm	#$67676767,d6,d6,d6
