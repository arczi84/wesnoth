...
std::vector<std::string> get_text() {
	static const char *credits[] = {
		...
		"-   JordĂ  Polo (ettin)",
		"-   Richard S. (Noy)",
		"-   Ruben Philipp WickenhĂ¤user (The Very Uhu)",
		...
		"-   Carles Company (brrr)",
		"-   Dan RosĂ s Garcia (focks)",
		"-   Daniel LĂłpez (Azazelo)",
		"-   Jonatan AlamĂ  (tin)",
		"-   JordĂ  Polo (ettin)",
		"-   Jose Gordillo (kilder)",
		"-   Mark Recasens",
		"-   Pau RulÂ·lan Ferragut",

		"_" N_("+Chinese Translation"),
		"-   ćž—äżŠćť° - Lim Choon Kiat",

		"_" N_("+Czech Translation"),
		"-   AneĹľka BubenĂ­ÄŤkovĂˇ (Bubu)",
		"-   David NeÄŤas (Yeti)",
		"-   LukĂˇĹˇ FaltĂ˝nek",
		"-   Martin Ĺ Ă­n",
		"-   Mintaka",
		...
		"-   dentro",
		"-   Gilluin",
		"-   KĂ©kkĹ‘i LĂˇszlĂł (BlackEvil)",
		"-   KertĂ©sz Csaba",
		"-   Khiraly",
		"-   KovĂˇcs DĂˇniel",
		"-   krix",
		"-   Salamon AndrĂˇs (ott)",
		"-   SzĂ©ll TamĂˇs (TomJoad)",
		...
		"-   ă�„ă�„ă‚€ă‚‰ă�Şă�Šă�Ť (amatubu) - Naoki Iimura",
		"-   ĺ˛ˇç”°äżˇäşş - Nobuhito Okada",
		"-   Yuji Matsumoto",
		...
		"-   David MartĂ­nez Moreno",
		"-   Flamma",
		"-   Francisco MuĂ±oz (fmunoz)",
		"-   Gabriel RodrĂ­guez (Chewie)",
		"-   IvĂˇn Herrero (navitux)",
		"-   Jose Gordillo (kilder)",
		"-   Jose Manuel Gomez (joseg)",

		"_" N_("+Swedish Translation"),
		"-   Alexander KjĂ¤ll (capitol)",
		"-   Leo Danielson (Lugo Moll)",
		"-   Stefan BergstrĂ¶m (tephlon)",
		"-   Susanna BjĂ¶rverud (sanna)",
		"-   wint3r",
